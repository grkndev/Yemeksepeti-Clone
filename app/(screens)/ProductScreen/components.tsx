...
export const ProductNote = ({ note, onChangeNote }: ProductNoteProps) => {
  const maxLength = 500;
...
export const OptionChoice = ({ name, price, isSelected, onSelect }: OptionChoiceProps) => {
  return (
    <TouchableOpacity
      onPress={onSelect}
...
export const OptionGroup = ({ name, required, choices, onSelect, isSelected }: OptionGroupProps) => {
  return (
    <View className="mb-6">
